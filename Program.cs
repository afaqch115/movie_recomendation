...
namespace MovieRecommendation
{
    class Program
    {
        ...
        private static string TrainingDataRelativePath = $"{DatasetsRelativePath}/rr_train.csv";
        private static string TestDataRelativePath = $"{DatasetsRelativePath}/rr_test.csv";
